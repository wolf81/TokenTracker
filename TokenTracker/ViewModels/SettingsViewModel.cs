...
namespace TokenTracker.ViewModels
{
    public class SettingsViewModel : ViewModelBase
    {
        private List<SettingItemBase> items = new List<SettingItemBase>
        {
            ...
            new ChooserSettingItem { Title = "Theme", Choices = new List<string> { "Light", "Dark" }, SelectedChoiceIndex = 0, IconImageSource = ImageSource.FromResource("TokenTracker.Resources.ic_theme_b.png") },
            ...
            new SwitchSettingItem { Title = "Disable Sleep", IsSelected = false, IconImageSource = ImageSource.FromResource("TokenTracker.Resources.ic_power_b.png") },
